...
home=r'''    private void showHome(){
        ...
        Button searchBtn=button("חיפוש",Color.rgb(119,125,130),Color.WHITE);searchBtn.setTextSize(16);LinearLayout.LayoutParams bp=new LinearLayout.LayoutParams(-1,dp(42));bp.setMargins(0,dp(5),0,0);searchBox.addView(searchBtn,bp);
