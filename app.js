...
(function(){
  ...
  boot().then(()=>{const oldOpen=window.openAdmin;if(oldOpen)window.openAdmin=async function(){await loadAdminExtras();if(window.refreshCatalogFromCloud)await window.refreshCatalogFromCloud();return oldOpen.apply(this,arguments)}}).catch(console.error);
})();